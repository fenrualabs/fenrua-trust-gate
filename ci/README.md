...
and the R2 schema-pin record check. Both third-party actions are pinned by
immutable full commit SHA. The CI job does not sign, publish, deploy, upload
evidence, contact a control plane, or claim a release.
